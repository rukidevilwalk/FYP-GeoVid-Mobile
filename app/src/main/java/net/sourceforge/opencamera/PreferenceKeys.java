...
public class PreferenceKeys {
    ...
    public static final String preference_user_logged_in_name = "user_is_logged_in_name";


    public static final String preference_user_logged_in = "user_is_logged_in";
